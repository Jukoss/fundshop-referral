...
var today_bsd_m = (yyyya-50)+'-'+mmaim+'-'+ddaim;
...
$(function() {
    $(document).ready(function() {
        ...
        $('#inp-pi-available-start-date').datepicker({
            autoclose: true,
            format: 'mm.dd.yyyy',
            startDate: mma+'.'+dda+'.'+yyyya,
            endDate: '+3m'
        }).on('changeDate', function(e) {
            $('#inp-pi-available-start-date').blur();
        });

        $('#inp-pi-dob').datepicker({
            autoclose: true,
            format: 'mm.dd.yyyy',
            startDate: mma+'.'+dda+'.'+(yyyya - 50),
            endDate: '12.31.'+(yyyya - 18)
        }).on('changeDate', function(e) {
            $('#inp-pi-dob').blur();
        });

        $('#inp-eh-aa-start-date').datepicker({
            autoclose: true,
            format: 'mm.dd.yyyy',
            startDate: mma+'.'+dda+'.'+yyyya,
            endDate: '+1y'
        }).on('changeDate', function(e) {
            $('#inp-eh-start-date').blur();
        });

        $('#inp-eh-aa-end-date').datepicker({
            autoclose: true,
            format: 'mm.dd.yyyy',
            startDate: mma+'.'+dda+'.'+yyyya,
            endDate: '+1y'
        }).on('changeDate', function(e) {
            $('#inp-eh-end-date').blur();
        });

        $('#inp-eh-bb-start-date').datepicker({
            autoclose: true,
            format: 'mm.dd.yyyy',
            startDate: mma+'.'+dda+'.'+yyyya,
            endDate: '+1y'
